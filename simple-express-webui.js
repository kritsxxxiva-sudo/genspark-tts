  ...
  setupRoutes() {
    ...
    this.app.post('/api/synthesize/trained', async (req, res) => {
      try {
        ...
        const audioBuffer = Buffer.from(result.audio.buffer);
...
<head>
    ...
    <title>GenSpark TTS - Trained Voice Synthesis</title>
    <style>
        body {
        ...
        <form id="synthesisForm">
            ...
            <div class="form-group">
                ...
                <select id="modelId" name="modelId" required>
                    <option value="thai_voice_9c7bb60b">thai_voice_9c7bb60b (Thai Trained Voice)</option>
                </select>
            </div>
